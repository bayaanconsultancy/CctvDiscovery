...
public class ResultsPanel extends JPanel {
    ...
    public ResultsPanel(WizardFrame frame, List<Camera> cameras) {
        ...
        tabbedPane.setForegroundAt(0, new Color(92, 184, 92));
        ...
        tabbedPane.setForegroundAt(1, new Color(220, 53, 69));
        
        // All tab
        JPanel allPanel = createResultsTable(cameras, null);
        tabbedPane.addTab("All (" + cameras.size() + ")", 
    ...
    private JPanel createResultsTable(List<Camera> cameras, Boolean successFilter) {
        ...
        for (Camera camera : cameras) {
            ...
            if (successFilter != null) {
                ...
                if (successFilter && !hasStreams) continue;
                if (!successFilter && hasStreams) continue;
            }
            
            String status = (camera.getMainStream() != null || camera.getSubStream() != null) ? "✓" : "✗";
        ...
        table.getColumnModel().getColumn(0).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, 
                ...
                if (!isSelected) {
                    if ("✓".equals(value)) {
                        c.setForeground(new Color(92, 184, 92));
