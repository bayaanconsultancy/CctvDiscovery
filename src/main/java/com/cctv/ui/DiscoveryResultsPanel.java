...
public class DiscoveryResultsPanel extends JPanel {
    ...
    public DiscoveryResultsPanel(WizardFrame frame, List<Camera> cameras, List<String> ipRange) {
        ...
        String message = cameras.isEmpty() ? 
            "No devices found via ONVIF" : 
        ...
        new SwingWorker<List<Camera>, Void>() {
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(frame, "Port scan failed: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        }.execute();
    }
